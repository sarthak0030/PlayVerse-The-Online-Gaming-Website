					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li><a href="manage-packages.php"><i class="fa fa-list" aria-hidden="true"></i>  <span>Manage games</span><div class="clearfix"></div></a></li>
									 <li><a href="create-package.php"><i class="fa fa-table"></i>  <span>Create games</span><div class="clearfix"></div></a></li>
